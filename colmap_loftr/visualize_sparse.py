...
def visualize_points(points_path):
    points3d = read_points3d_binary(points_path)
    points = np.asarray([points3d[i].xyz for i in points3d.keys()])
...
def create_images_npz(images_path):
    ...
    for i in images:
        ...
        # t /= t[3]
        t = t[:3]
        extrinsics[:3, :] = np.concatenate((R, t), axis=1)
        params.append(extrinsics)
    
    np.savez('/media/ryan/DATA/HDR_Surface_Reconstruction/my_data/extrinsic2pyramid/images.npz', params=params)
...
if __name__ == "__main__":
    ...
    # args.func(args)
    points_path = '/media/ryan/DATA/HDR_Surface_Reconstruction/my_data/Bracketed_Rubik/loftr_-3_0/sparse/0/points3D.bin'
    images_path = '/media/ryan/DATA/HDR_Surface_Reconstruction/my_data/Bracketed_Rubik/loftr_-3_0/sparse/0/images.bin'
    create_images_npz(images_path)
